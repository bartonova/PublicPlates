  ...
  plugins: [
    new webpack.DefinePlugin({
      'process.env': {
        ...
        // The root URL for API calls, ending with a '/' - for example: `"https://www.freedata.tech:8081/myservice/"`.
        // If this URL is left empty (""), then it will be relative to the current context.
        // If you use an API server, in `prod` mode, you will need to enable CORS
        // (see the `freedata.cors` common freedata property in the `application-*.yml` configurations)
        SERVER_API_URL: `''`
      }
    }),
    ...
    new CopyWebpackPlugin([
      ...
      // freedata-needle-add-assets-to-webpack - freedata will add/remove third-party resources in this array
    ...
    new MergeJsonWebpackPlugin({
      output: {
        groupBy: [
                    ...
                    // freedata-needle-i18n-language-webpack - freedata will add/remove languages in this array
                ]
      }
    }),
  ]
