  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="platesApp.department.home.createOrEditLabel">
            <Translate contentKey="platesApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
