  ...
  return (
    <div>
      <h2 id="department-heading">
        <Translate contentKey="platesApp.department.home.title">Departments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="platesApp.department.home.createLabel">Create new Department</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('platesApp.department.home.search')}
                />
        ...
        {departmentList && departmentList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="platesApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
