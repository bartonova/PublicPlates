...
public class MailServiceIT {
    ...
    private static final String[] languages = {
        ...
        "ua",
        "vi"
        // freedata-needle-i18n-language-constant - freedata will add/remove languages in this array
    };
    private static final Pattern PATTERN_LOCALE_3 = Pattern.compile("([a-z]{2})-([a-zA-Z]{4})-([a-z]{2})");
    private static final Pattern PATTERN_LOCALE_2 = Pattern.compile("([a-z]{2})-([a-z]{2})");

    @Autowired
    private freedataProperties freedataProperties;
    ...
    public void setup() {
        ...
        mailService = new MailService(freedataProperties, javaMailSender, messageSource, templateEngine);
    }
    ...
    public void testSendEmail() throws Exception {
        ...
        assertThat(message.getFrom()[0].toString()).isEqualTo(freedataProperties.getMail().getFrom());
